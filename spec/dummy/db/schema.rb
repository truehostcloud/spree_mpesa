...
ActiveRecord::Schema[8.1].define(version: 2026_06_29_035157) do
  ...
  create_table "spree_metafields", force: :cascade do |t|
    t.datetime "created_at", null: false
    t.integer "metafield_definition_id", null: false
    t.integer "resource_id", null: false
    t.string "resource_type", null: false
    t.string "type", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "spree_mpesa_sources", force: :cascade do |t|
    t.decimal "amount", precision: 10, scale: 2
    ...
    t.datetime "updated_at", null: false
    t.integer "user_id"
    t.index ["checkout_request_id"], name: "index_spree_mpesa_sources_on_checkout_request_id"
    t.index ["deleted_at"], name: "index_spree_mpesa_sources_on_deleted_at"
    t.index ["merchant_request_id"], name: "index_spree_mpesa_sources_on_merchant_request_id"
    t.index ["payment_method_id"], name: "index_spree_mpesa_sources_on_payment_method_id"
    t.index ["user_id"], name: "index_spree_mpesa_sources_on_user_id"
  end
  ...
  create_table "spree_orders", force: :cascade do |t|
    ...
    t.integer "preferred_stock_location_id"
    t.json "private_metadata"
    t.decimal "promo_total", precision: 10, scale: 2, default: "0.0"
    t.json "public_metadata"
  ...
  create_table "spree_policy_translations", force: :cascade do |t|
    ...
    t.string "locale", null: false
    t.string "name"
    t.integer "spree_policy_id", null: false
    t.datetime "updated_at", null: false
